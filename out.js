...
var _fetchJsonp = __webpack_require__(37);

var _fetchJsonp2 = _interopRequireDefault(_fetchJsonp);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var FETCH_PHOTO_DATA = 'FETCH_PHOTO_DATA';

var FLICKR_URL = 'http://api.flickr.com/services/feeds/photos_public.gne?format=json&tags=';

function fetchPhoto(keyword) {
  var url = FLICKR_URL + keyword;
...
exports.default = FETCH_PHOTO_DATA;
...
var _getPrototype = __webpack_require__(52);
...
var _nullthrows = __webpack_require__(78);
...
window.onload = function () {
  var appContainer = (0, _nullthrows2.default)(document.getElementById('app'));
...
var _PhotoSearch = __webpack_require__(34);

var _PhotoSearch2 = _interopRequireDefault(_PhotoSearch);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_PhotoSearch2.default, null),
...
var _PhotoList = __webpack_require__(35);
...
var PhotoSearch = function PhotoSearch() {
  return _react2.default.createElement(
    'div',
    null,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      photos.map(function (photo, i) {
        return _react2.default.createElement(_Photo2.default, { key: photo.title + i, photo: photo });
      })
    )
  );
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchPhoto: function fetchPhoto(keyword) {
      return dispatch((0, _index.fetchPhoto)(keyword));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(PhotoList);
...
var _selectorFactory = __webpack_require__(63);
...
var _freeGlobal = __webpack_require__(49);
...
var _verifySubselectors = __webpack_require__(64);
...
var SearchBox = function (_React$Component) {
  ...
  function SearchBox(props) {
    ...
    _this._handleSubmit = function (event) {
      ...
      _this.props.fetchPhoto(keyword);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { type: 'submit', className: 'btn btn-lg #4A9586' },
            'search photos'
          )
        )
      );
...
exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(SearchBox);
...
var Store = (0, _redux.createStore)(_root2.default, composeEnhancers((0, _redux.applyMiddleware)(_reduxThunk2.default)));
...
var rootReducer = function rootReducer() {
  ...
  switch (action.type) {
    case _index2.default:
      var photos = action.payload.items;
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(4);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(24);var _assign=__webpack_require__(3);var emptyFunction=__webpack_require__(2);var checkPropTypes=__webpack_require__(7);var getActiveElement=__webpack_require__(25);var shallowEqual=__webpack_require__(26);var containsNode=__webpack_require__(27);var emptyObject=__webpack_require__(5);var hyphenateStyleName=__webpack_require__(74);var camelizeStyleName=__webpack_require__(76);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
